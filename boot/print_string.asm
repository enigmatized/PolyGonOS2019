;This is just the 
; 16 bit printing from the tutorial
;
;I messed around with combining his files before our first meet up
;I had problems with the makefile
;I eneded up using that because it just organizes the files better......
;Nothing new or mindblowing here
;Literally his tutorial copied and pasted.
