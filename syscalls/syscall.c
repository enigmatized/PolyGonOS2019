...
//This was molded off of a few sources
//https://github.com/csarron/cse506os
//
//
...
//if the syscall_exit_flag is 0, 
//that means the threading system has spun up the thread
        THREAD* thread = (THREAD*) parameter;
...
void do_syscall(uint_t call_num, void* parameter){
    ...
    int syscall_exit_flag; 
//this flag lets us determine if this is completing the original do_syscall exit, 
//or the threading system spinning up a thread for the first time
//hrs.....
